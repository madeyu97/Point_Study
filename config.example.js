/* ═══════════════════════════════════════════════════════════
   POINT STUDY — your settings   ***  TEMPLATE  ***

   This file is called config.example.js on purpose.

   Copy it to config.js, fill it in, upload it ONCE, and never
   upload it again. Updates to the app ship this template, never
   your real config.js — so your keys cannot be overwritten.
